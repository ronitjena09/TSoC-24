...
// const signUpResponse = await authModule.signUp({ email: "ronitjena64@gmail.com", password: "string" });
// console.log(signUpResponse);

const loginResponse = await authModule.login({ email: "ronitjena64@gmail.com", password: "string" });
